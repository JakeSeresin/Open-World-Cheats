...
import { exportCheats } from '@/lib/export';
...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    // Simulate a brief skeleton phase for graceful load
  ...
  const handleHistorySelect = useCallback((id: string) => {
    setQuery('');
    // highlight or scroll to cheat — minimal: just clear filters
    setGame('all');
    setCategory('all');
    setPlatform('all');
  }, []);
  ...
  }, [query, game, category, platform, showFavs, favorites]);
    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="space-y-3">
          ...
          {/* Category + platform filters (compact row) */}
